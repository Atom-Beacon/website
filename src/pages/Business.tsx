...
export const companies: Company[] = [
  ...
  },
  {
    ...
    slug: "uranium-energy-corp",
    website: "https://www.uraniumenergy.com",
    hq: "Corpus Christi, Texas, USA",
    focus: "U.S.-focused uranium mining, exploration, and physical uranium holdings",
    purePlay: true,
    isPublic: true,
    ticker: "UEC",
    exchange: "NYSE American",
    description: "Uranium Energy Corp (UEC) is the largest U.S.-listed pure-play uranium company, focused on low-cost in-situ recovery (ISR) production in Texas and Wyoming. UEC owns two fully licensed and constructed ISR hub-and-spoke processing platforms — the Hobson plant in South Texas and the Irigaray plant in Wyoming — plus a portfolio of permitted U.S. projects and exploration assets in Canada (Athabasca Basin) and Paraguay. The company also holds one of the largest physical uranium inventories of any North American producer, acquired during periods of low spot prices.",
    exciting: "UEC is positioned as a domestic supply solution at a time when U.S. utilities and the federal government are actively working to reduce dependence on Russian and Kazakh uranium. The company restarted production at its Wyoming Christensen Ranch operation in 2024 and is ramping ISR output across its Texas and Wyoming hubs. Its physical uranium holdings act as a leveraged play on uranium spot prices without the operational risks of new mine construction. UEC's Athabasca Basin assets (acquired via the UEX and Rio Tinto Roughrider transactions) give it exposure to some of the highest-grade undeveloped uranium deposits on Earth.",
    challenges: "Uranium spot prices remain volatile and well below incentive levels for some higher-cost projects. ISR production ramp-ups have historically taken longer than projected. UEC remains unprofitable on a GAAP basis in most quarters, with earnings heavily influenced by uranium price movements and inventory revaluations. Permitting for new U.S. mines is slow, and water-use regulations affect ISR specifically.",
    recentNews: [
      { title: "UEC reports production ramp at Christensen Ranch and Hobson hub", url: "https://www.uraniumenergy.com/news/" },
      { title: "UEC completes acquisition of Rio Tinto's Roughrider uranium project", url: "https://www.uraniumenergy.com/news/" },
      { title: "UEC quarterly results and physical uranium inventory update", url: "https://www.uraniumenergy.com/news/" },
    ],
  },
  {
    ...
    focus: "Uranium exploration and development in Canada's Athabasca Basin",
    purePlay: true,
    isPublic: true,
    ticker: "DNN",
    exchange: "NYSE American",
    description: "Denison Mines is a uranium exploration and development company with a portfolio of projects in Saskatchewan's Athabasca Basin, the highest-grade uranium district in the world. Its flagship asset is the 95%-owned Wheeler River project, which hosts the Phoenix and Gryphon deposits. Phoenix is being developed as the first in-situ recovery (ISR) uranium mine in Canada — a technique long used in the U.S. and Kazakhstan but new to the high-grade hard-rock geology of the Athabasca. Denison also holds a 22.5% interest in the McClean Lake mill operated by Orano and a stake in physical uranium through the Uranium Participation Corporation lineage.",
    exciting: "Wheeler River Phoenix is one of the few near-term new uranium mines globally with strong economics: a feasibility study supports very low operating costs by ISR standards and a long mine life. Denison received Canadian Nuclear Safety Commission (CNSC) hearing dates and continues to advance permitting toward a final construction decision. Successful ISR proof-of-concept work in 2022-2024 was a major de-risking event. Denison's project pipeline (Wheeler River, Waterbury Lake, McClean North) provides multi-decade growth optionality in the world's premier uranium district.",
    challenges: "Wheeler River still requires final regulatory approval and a construction decision; first production is several years away. ISR has never been commercially proven in Athabasca-style high-grade sandstone-hosted deposits, so technical execution risk is real. Denison is pre-production and dependent on equity markets and uranium prices for capital. Canadian regulatory timelines are thorough but slow.",
    recentNews: [
      { title: "Denison advances Wheeler River Phoenix toward construction decision", url: "https://www.denisonmines.com/news/" },
      { title: "Denison reports ISR field test results from Phoenix deposit", url: "https://www.denisonmines.com/news/" },
