const Accessibility = () => (
  <div className="container py-12 max-w-3xl mx-auto">
    ...
    <div className="retro-card space-y-4 text-muted-foreground leading-relaxed">
      ...
      <p>Atomic Pulse is committed to ensuring digital accessibility for all users, including those with disabilities. We strive to conform to WCAG 2.1 Level AA standards.</p>
