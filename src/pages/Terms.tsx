const Terms = () => (
  <div className="container py-12 max-w-3xl mx-auto">
    ...
    <div className="retro-card space-y-4 text-muted-foreground leading-relaxed">
      ...
      <p>By using Atomic Pulse, you agree to these Terms of Use. If you do not agree, please do not use this site.</p>
      ...
      <p>Original content on Atomic Pulse is protected by copyright. You may share and reference our content with proper attribution.</p>
      <h2 className="font-heading text-xl font-semibold text-foreground pt-4">Limitation of Liability</h2>
      <p>Atomic Pulse is provided "as is" without warranties of any kind. We are not liable for any decisions made based on information provided on this site.</p>
